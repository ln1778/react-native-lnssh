...
import static com.lnssh.ImagePicker.ImagePickerModule.*;
...
public class Utils {
   ...
   */
	...
	public static ReadableMap getResponseMap(List<Uri> fileUris, Options options, Context context) throws RuntimeException {
